...
def get_parser():
    ...
    aa('--tile', type=utils.bool_inst, default=False, help='Enable tiling. (Default: False)')
...
def main(params):
    ...
    if params.tile:
        ...
        params.scale_channels, params.scaling_i, params.scaling_w, params.num_bits, params.redundancy, params.tile, params.tile_size, params.tile_type)
    else:
